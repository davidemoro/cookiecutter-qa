...
Report bugs at https://github.com/tierratelematics/cookiecutter-qa/issues
...
Cookiecutter QA could always use more documentation, whether as part of the
official docs, in docstrings, or even on the web in blog posts, articles, and such.

Submit Feedback
~~~~~~~~~~~~~~~

The best way to send feedback is to file an issue at https://github.com/tierratelematics/cookiecutter-qa/issues.
...
Ready to contribute? Here's how to set up `cookiecutter-qa` for local development. Please note this documentation assumes
you already have `virtualenv` and `Git` installed and ready to go.

1. Fork the `cookiecutter-qa` repo on GitHub.
2. Clone your fork locally::

  .. code-block:: bash

    $ cd path_for_the_repo
    $ git clone git@github.com:YOUR_NAME/cookiecutter-qa.git
...
3. Assuming you have virtualenv installed (If you have Python3.5 this should already be there), you can create a new environment for your local development by typing::
  ...
  .. code-block:: bash
    ...
    $ virtualenv cookiecutter-qa-env
    $ source cookiecutter-qa-env/bin/activate
...
6. The next step would be to run the test cases. `cookiecutter-qa` uses py.test, you can run PyTest. Before you run pytest you should ensure all dependancies are installed::
...
3. The pull request should work for Python 2.6, 2.7, 3.3, 3.4 and 3.5, and for PyPy. Check
   https://travis-ci.org/tierratelematics/cookiecutter-qa/pull_requests
