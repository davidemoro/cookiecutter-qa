...
#
# html_title = u'{{cookiecutter.project_slug}} v0.1'
...
latex_documents = [
    (master_doc, '{{cookiecutter.project_slug}}.tex', u'tierra\\_qa Documentation',
...
texinfo_documents = [
    (master_doc, '{{cookiecutter.project_slug}}', u'{{cookiecutter.project_slug}} Documentation',
     author, '{{cookiecutter.project_slug}}', 'Tierra QA project',
     'Miscellaneous'),
]
